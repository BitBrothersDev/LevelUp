...
ActiveRecord::Schema[7.0].define(version: 2022_07_24_173310) do
  ...
  create_table "estimation_skill_level_items", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.float "level"
    t.bigint "user_id", null: false
